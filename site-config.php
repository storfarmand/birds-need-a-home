...
$site_mode = 'T'; // P - Production, T - Test

if ($site_mode == 'P') {
    error_reporting(0);
    $site_hostname = 'www.birds-need-a-home.dk';
    //Where does the contact form get sent to?
    $mail_contact = "admin@birds-need-a-home.dk";
    $site_fs_base = "/var/www/birds-need-a-home.dk/public_html/";
    $db_host = 'mysql38.unoeuro.com';
    $db_user = 'birds_need__dk';
    $db_pass = 'P3t3rs3n';
    $db_database = 'birds_need_a_home_dk_db';
    $mailHost = "smtp.unoeuro.com";
    $mailPort = 25;
    $mailAuth = false;
    $mailUser = "admin@birds-need-a-home.dk";
    $mailPass = "P3t3rs3n";
    $mailDebug = 0;
    ...
    $site_fs_base = "/www/birds-need-a-home/";
    $db_host = 'localhost';
    $db_user = 'root';
    $db_pass = 'root';
    $db_database = 'birds_need_a_home_dk_db';
    ...
    $mailPort = 587;
    $mailAuth = true;
    $mailUser = "kontakt@birds-need-a-home.dk";
    $mailPass = "op7913";
    $mailDebug = 2;
    $mailBCC = array("charlotte@hjarl.dk", "storfarmand@gmail.com");
}
...
$site_debug=0;
$site_domain      = "birds-need-a-home.dk";                 // The domain name of the customer
$site_name        = "Birds Need a Home";                    // The business name of the customer
$site_base        = "http://$site_hostname/";               // Base URL to the homepage
$site_launch      = "http://$site_hostname/index.php";      // URL to launch the homepage
$site_form_name   = "frm_bh";                              // Name of the HTML form
